...
var Anchor = function () {
  ...
  _createClass(Anchor, [{
    ...
    value: function setMove(x, y) {
      this.command = 'move';
      if (x instanceof _vector2.default) {
        this.vec1 = x;
      } else {
    ...
    value: function setCurve(a, b, c, d, e, f) {
      var args = _utils2.default.expandVectorArguments(arguments);
      this._setCurveImpl.apply(this, args);
      return this;
    }
  }, {
    key: "_setCurveImpl",
    value: function _setCurveImpl(a, b, c, d, e, f) {
...
},{"./bezier":114,"./utils":131,"./vector":132}],114:[function(_dereq_,module,exports){
"use strict";
...
(0, _assign2.default)(Group.prototype, _mixins.Moveable, _mixins.VectorsAcceptable, { type: "group" });
...
exports.VectorsAcceptable = exports.Styleable = exports.Sizeable = exports.Moveable = undefined;
...
var VectorsAcceptable = {
  ...
  vectorsAcceptable: function vectorsAcceptable(argsObject) {
    var args = _utils2.default.expandVectorArguments(argsObject);
    if (this.init) {
...
exports.VectorsAcceptable = VectorsAcceptable;
...
var Rune = function () {
  ...
  _createClass(Rune, [{
    ...
    value: function group(x, y, parent) {
      var g = _utils2.default.invokeConstructor(_group2.default, arguments);
      _utils2.default.groupLogicFromArguments(g, this.stage, arguments);
      return g;
    }
  }, {
    key: "triangle",
    value: function triangle(x, y, x2, y2, x3, y3, parent) {
      var t = _utils2.default.invokeConstructor(_triangle2.default, arguments);
      _utils2.default.groupLogicFromArguments(t, this.stage, arguments);
      return t;
    }
  }, {
    key: "rect",
    value: function rect(x, y, width, height, parent) {
      var r = _utils2.default.invokeConstructor(_rectangle2.default, arguments);
      _utils2.default.groupLogicFromArguments(r, this.stage, arguments);
      return r;
    }
  }, {
    key: "ellipse",
    value: function ellipse(x, y, width, height, parent) {
      var e = _utils2.default.invokeConstructor(_ellipse2.default, arguments);
      _utils2.default.groupLogicFromArguments(e, this.stage, arguments);
      return e;
    }
  }, {
    key: "circle",
    value: function circle(x, y, radius, parent) {
      var c = _utils2.default.invokeConstructor(_circle2.default, arguments);
      _utils2.default.groupLogicFromArguments(c, this.stage, arguments);
      return c;
    }
  }, {
    key: "line",
    value: function line(x1, y1, x2, y2, parent) {
      var l = _utils2.default.invokeConstructor(_line2.default, arguments);
      _utils2.default.groupLogicFromArguments(l, this.stage, arguments);
      return l;
    }
  }, {
    key: "polygon",
    value: function polygon(x, y, parent) {
      var p = _utils2.default.invokeConstructor(_polygon2.default, arguments);
      _utils2.default.groupLogicFromArguments(p, this.stage, arguments);
      return p;
    }
  }, {
    key: "path",
    value: function path(x, y, parent) {
      var p = _utils2.default.invokeConstructor(_path2.default, arguments);
      _utils2.default.groupLogicFromArguments(p, this.stage, arguments);
      return p;
    }
  }, {
    ...
    value: function text(textString, x, y, parent) {
      var t = _utils2.default.invokeConstructor(_text2.default, arguments);
      _utils2.default.groupLogicFromArguments(t, this.stage, arguments);
      return t;
    }
  }, {
    ...
    value: function image(url, x, y, width, height, parent) {
      var i = _utils2.default.invokeConstructor(_image2.default, arguments);
      _utils2.default.groupLogicFromArguments(i, this.stage, arguments);
      return i;
    }
  }, {
    key: "grid",
...
(0, _assign2.default)(Circle.prototype, _mixins.Moveable, _mixins.Styleable, _mixins.VectorsAcceptable, { type: "circle" });
...
var Ellipse = function () {
  ...
  _createClass(Ellipse, [{
    key: "init",
    value: function init(x, y, width, height) {
      this.vars.x = x;
      this.vars.y = y;
...
(0, _assign2.default)(Ellipse.prototype, _mixins.Moveable, _mixins.Sizeable, _mixins.Styleable, _mixins.VectorsAcceptable, { type: "ellipse" });
...
var Image = function () {
  ...
  _createClass(Image, [{
    key: "init",
    value: function init(url, x, y, width, height) {
      this.vars.url = url;
      this.vars.x = x;
      this.vars.y = y;
      this.vars.width = width;
...
(0, _assign2.default)(Image.prototype, _mixins.Moveable, _mixins.Sizeable, _mixins.VectorsAcceptable, { type: "image" });
...
(0, _assign2.default)(Line.prototype, _mixins.Moveable, _mixins.Styleable, _mixins.VectorsAcceptable, { type: "line" });
...
(0, _assign2.default)(Path.prototype, _mixins.Moveable, _mixins.Styleable, _mixins.VectorsAcceptable, { type: "path" });
...
(0, _assign2.default)(Polygon.prototype, _mixins.Moveable, _mixins.Styleable, _mixins.VectorsAcceptable, { type: "polygon" });
...
(0, _assign2.default)(Rectangle.prototype, _mixins.Moveable, _mixins.Sizeable, _mixins.Styleable, _mixins.VectorsAcceptable, { type: "rectangle" });
...
(0, _assign2.default)(Text.prototype, _mixins.Moveable, _mixins.Styleable, _mixins.VectorsAcceptable, { type: "text" });
...
var Triangle = function () {
  ...
  _createClass(Triangle, [{
    key: "init",
    value: function init(x, y, x2, y2, x3, y3) {
      this.vars.x = x;
      this.vars.y = y;
...
(0, _assign2.default)(Triangle.prototype, _mixins.Moveable, _mixins.Styleable, _mixins.VectorsAcceptable, { type: "triangle" });
...
var Utils = {
  ...
  groupLogicFromArguments: function groupLogicFromArguments(child, fallback, argsObject) {
  ...
  expandVectorArguments: function expandVectorArguments(argObject) {
    ...
    for (var i = 0; i < args.length; i++) {
      if (args[i] instanceof _vector2.default) {
        var vec = args[i];
        args.splice(i, 1);
...
},{"./vector":132}],132:[function(_dereq_,module,exports){
"use strict";
...
var Vector = function () {
  ...
  _createClass(Vector, [{
    ...
    value: function rotate(degrees) {
      ...
      var len = this.length();
      var x = _utils2.default.round(Math.cos(rad) * len, ROUND_PRECISION);
      var y = _utils2.default.round(Math.sin(rad) * len, ROUND_PRECISION);
      return new Vector(x, y);
    }
  }, {
    key: "copy",
